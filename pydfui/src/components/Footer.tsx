...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200 text-gray-600 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 px-4 py-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-200 group"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-200 group"
              >
                <FaSquareUpwork className="text-2xl text-blue-600 group-hover:scale-110 transition-transform" />
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-200 group"
              >
                <TbBrandFiverr className="text-2xl text-blue-600 group-hover:scale-110 transition-transform" />
                <span className="text-sm">Fiverr</span>
              </a>
            </div>
            <a
              href="mailto:rdan99848@gmail.com"
              className="flex items-center gap-2 mt-4 px-4 py-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-200 group"
            >
              <FaEnvelope className="text-xl text-blue-600 group-hover:scale-110 transition-transform" />
          ...
          <div>
            ...
            {message && (
              <p className={`mt-3 text-sm text-center ${message.includes('Thank') ? 'text-blue-600' : 'text-red-400'}`}>
                {message}
              </p>
            )}
          </div>
